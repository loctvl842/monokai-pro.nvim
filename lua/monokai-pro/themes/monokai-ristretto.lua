...
local monokai_ristretta = {
	...
	scrollbarSliderHoverBackground = util.hexExtend("#c3b7b826", "#2c2525"), -- background: background
	scrollbarSliderHoverBackgroundPmenuThumb = util.hexExtend("#c3b7b826", "#403838"), -- background: suggestWidgetBackground
